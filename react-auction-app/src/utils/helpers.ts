...
// DRY: Common functions used across the application
// ============================================================================
 ...
 */
export function getPlayerAvatarUrl(imageUrl: string | undefined, name: string): string {
  if (imageUrl?.trim()) {
    return imageUrl;
  }
  return DEFAULT_AVATARS.PLAYER(name);
}

/**
 * Get team logo URL with fallback
 */
export function getTeamLogoUrl(logoUrl: string | undefined, name: string): string {
  if (logoUrl?.trim()) {
    return logoUrl;
  }
  return DEFAULT_AVATARS.TEAM(name);
}
